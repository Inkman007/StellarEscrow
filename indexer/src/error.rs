...
impl IntoResponse for AppError {
    fn into_response(self) -> Response {
        let (status, code, message) = match &self {
            ...
            AppError::InvalidMimeType(_)  => (StatusCode::UNSUPPORTED_MEDIA_TYPE,"INVALID_MIME",       "Unsupported file type"),
            AppError::InvalidFileCategory => (StatusCode::BAD_REQUEST,           "INVALID_CATEGORY",   "Invalid file category"),
